(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("doubleW", [], factory);
	else if(typeof exports === 'object')
		exports["doubleW"] = factory();
	else
		root["doubleW"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _queuarablePromise = __webpack_require__(190);

	var _queuarablePromise2 = _interopRequireDefault(_queuarablePromise);

	var Point = (function () {
	  function Point(data, options) {
	  ...
	  _createClass(Point, [{
	    key: '_spawnWorker',
	    value: function _spawnWorker(cb, env) {

	      var src = 'self.onmessage = function(e) {self.postMessage((' + cb.toString() + ')(e.data))}';
	    ...
	    key: 'startWorker',
	    value: function startWorker(worker, data, index) {
	      data = data || this.data;
...
/***/ function(module, exports) {
	...
	exports["default"] = MakeQuerablePromise;
	module.exports = exports["default"];
